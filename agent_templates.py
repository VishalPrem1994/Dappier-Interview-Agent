...
def get_final_evaluation_template(profile_match_score, conversation):
    return f"""
        ...
        {conversation}
        Give a score out of 10 based on the candidate's experience with the skills required in the job description and also weighing the profile matching score of {profile_match_score} out of 10.
